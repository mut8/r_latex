setwd("/home/lluc/Documents/R/dip/vanja")
...
peaks.vanja<-read.csv("peaks_vanja.csv", sep=";", header=TRUE)
...
# sums by category
      ...
      mass.series((catrcTIC.vanja$g), harvest, samples.vanja$massloss, samples.vanja$masslossSE, type, "Lignin related compounds", "remaining dry mass (%, SE)", "(remaining dry mass) * (relative peak areas/initial relative peak area) (%, SE)", c(75,110), allpoints=FALSE, col=TRUE, normalize=FALSE, legende=TRUE, losscorr=TRUE)
	x <- catrcTIC.vanja$f+catrcTIC.vanja$cp+catrcTIC.vanja$ch
      timeseries(x, harvest, type, c(min(x),max(x)), "carbohydrates", "litter incubation (month)", "sum of cTIC peak area (permille of all peaks)", allpoints=TRUE, col=TRUE)
...
#timeseries	
	...
	x <- catrcTIC.vanja$f+catrcTIC.vanja$cp+catrcTIC.vanja$ch
	name <- "carbohydrate markers"
      timeseries(x, harvest, type, c(min(x), max(x)), name, "litter incubation (month)", "sum of cTIC peak area (permille of all peaks)", allpoints=TRUE, col=TRUE)
#      mass.series(x, harvest, samples.vanja$massloss, samples.vanja$masslossSE, type, name, "remaining dry mass (%, SE)", "(remaining dry mass) * (relative peak areas/initial relative peak area) (%, SE)", c(65,130), allpoints=FALSE, col=TRUE, normalize=TRUE, legende=TRUE, losscorr=TRUE)

	x <- catrcTIC.vanja$g+catrcTIC.vanja$sy
	name <- "lignin markers"
      timeseries(x, harvest, type, c(min(x), max(x)), name, "litter incubation (month)", "sum of cTIC peak area (permille of all peaks)", allpoints=TRUE, col=TRUE)
#      mass.series(x, harvest, samples.vanja$massloss, samples.vanja$masslossSE, type, name, "remaining dry mass (%, SE)", "(remaining dry mass) * (relative peak areas/initial relative peak area) (%, SE)", c(65,130), allpoints=FALSE, col=TRUE, normalize=TRUE, legende=TRUE, losscorr=TRUE)

	x <- (catrcTIC.vanja$g+catrcTIC.vanja$sy)/(catrcTIC.vanja$ch+catrcTIC.vanja$cp+catrcTIC.vanja$f)
	name <- "lignin : carbohydrates"
      timeseries(x, harvest, type, c(min(x), max(x)), name, "litter incubation (month)", "sum of cTIC peak area (permille of all peaks)", allpoints=TRUE, col=TRUE)

	x <- (catrcTIC.vanja$g+catrcTIC.vanja$sy)/(catrcTIC.vanja$n)
	 name <- "lignin : nitrogen"
      timeseries(x, harvest, type, c(min(x), max(x)), name, "litter incubation (month)", "sum of cTIC peak area (permille of all peaks)", allpoints=TRUE, col=TRUE)
...
#{  
#	 x <- rsim.vanja[,i]
#	name<-paste(peaks.vanja$name[i], peaks.vanja$RT[i], peaks.vanja$type[i])
#
#      timeseries(x, harvest, type, c(min(x), max(x)), name, "litter incubation (month)", "sum of cTIC peak area (permille of all peaks)", allpoints=TRUE, col=TRUE)
#      mass.series(x, harvest, samples.vanja$massloss, samples.vanja$masslossSE, type, name, "remaining dry mass (%, SE)", "(remaining dry mass) * (relative peak areas/initial relative peak area) (%, SE)", c(65,130), allpoints=FALSE, col=TRUE, normalize=TRUE, legende=TRUE, losscorr=TRUE)
#}
...
# pca with all peaks.vanja
      ...
      text(vanja.allpeaks.pca, display="species", labels=peaks.vanja[,5], cex=.5)
...
timeseries(rsim.vanja[,9], harvest, type, "name", "x", "y", allpoints=TRUE)
